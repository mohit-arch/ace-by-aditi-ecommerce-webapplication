...
<head>
  ...
  <!-- fonts style -->
  <link href="ttps://fonts.googleapis.com/css?family=Poppins:400,600,700&display=swaph" rel="stylesheet">
...
while($row = mysqli_fetch_assoc($result)){
    ...
    <tr>
        ...
        <td><img src='images/".$row['file_name']."'width=100px height=100px ></td>
        <td>".$row['name']."</td>
        <td>".$row['price']."</td>
